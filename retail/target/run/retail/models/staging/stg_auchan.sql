  ...
  create view "airflow"."public_staging"."stg_auchan__dbt_tmp"
...
raw_category as (
    select distinct on (product_name)
        product_name,
        category
    from "airflow"."public"."auchan_cat"
...
raw_section as (
    select distinct on (product_name)
        product_name,
        section
    from "airflow"."public"."auchan_section"
...
raw_norm as (
    select distinct on (name)
        ...
        END AS quantity
    from "airflow"."public"."auchan_norm"
