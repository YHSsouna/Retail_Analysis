  ...
  create  table "airflow"."public_intermediate"."inter_carrefour__dbt_tmp"
...
image_url_dates AS (
    ...
    FROM "airflow"."public_staging"."stg_carrefour"
...
joined AS (
    ...
    LEFT JOIN "airflow"."public_staging"."stg_carrefour" a
