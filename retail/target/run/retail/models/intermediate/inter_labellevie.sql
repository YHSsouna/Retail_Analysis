  ...
  create  table "airflow"."public_intermediate"."inter_labellevie__dbt_tmp"
...
image_url_dates AS (
    ...
    FROM "airflow"."public_staging"."stg_labellevie"
...
joined AS (
    ...
    LEFT JOIN "airflow"."public_staging"."stg_labellevie" a
