...
section_auchan = BashOperator(
    task_id='section_auchan',
    bash_command='python /opt/airflow/web_scraping_scripts/auchan_section.py',
    dag=dag,
)
...
scrape_auchan >> section_auchan >> categorize_auchan
scrape_auchan >> normalize_auchan
