...
section_labellevie = BashOperator(
    task_id='section_labellevie',
    bash_command='python /opt/airflow/web_scraping_scripts/labellevie_section.py',
    dag=dag,
)
...
scrape_labellevie >> section_labellevie >> categorize_labellevie
scrape_labellevie >> normalize_labellevie