...
section_carrefour = BashOperator(
    task_id='section_carrefour',
    bash_command='python /opt/airflow/web_scraping_scripts/carrefour_section.py',
    dag=dag,
)

scrape_carrefour >> section_carrefour >> categorize_carrefour
